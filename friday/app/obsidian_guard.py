"""Obsidian sensitive-content guard helpers."""
...
class ObsidianGuardResult:
    """Structured result for Obsidian write sensitive-content validation."""
...
def check_obsidian_note_for_write(
    body: str | None = None,
    frontmatter_text: str | None = None,
    relationship_context: str | None = None,
    notes: str | None = None,
) -> ObsidianGuardResult:
    """Validate Obsidian write free text before any local file write."""
